...
use caliptra_builder::{ImageOptions, APP_WITH_UART, FMC_WITH_UART, ROM_VAL_WITH_UART};
...
const FMC_CANNED_DIGEST: [u32; 12] = [
    0x350e86cc, 0xee4d3661, 0xa762876f, 0xaf32bd3b, 0x2b247441, 0xed71c8cf, 0x1a879b16, 0x22c01b78, 0x3bf33f20, 0x175ff040, 0xad745126, 0x75dd9af1,
];
            ...
            DiceTcbInfo {
                ...
                fwids: vec![
                    DiceFwid {
                        ...
                        digest: swap_word_bytes(&FMC_CANNED_DIGEST)
                        .as_bytes()
                        .to_vec(),
                    },
                    DiceFwid {
